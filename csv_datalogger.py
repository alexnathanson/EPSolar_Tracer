# pymodbus code originally based on an  example from http://www.solarpoweredhome.co.uk/
# most recent edits come from the Solar Protocol project: https://github.com/alexnathanson/solar-protocol
...
#the syntax for the unit argument changes depending on which version of pymodbus is running
